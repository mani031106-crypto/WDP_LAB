...
if __name__ == "__main__":
    eligibility_report({"roll_no": "SAMS25CS014", "cgpa": 8.6, "attendance": 92, "income": 480000})
    eligibility_report({"roll_no": "SAMS25CS020", "cgpa": 4.3, "attendance": 60, "income": 350000})
